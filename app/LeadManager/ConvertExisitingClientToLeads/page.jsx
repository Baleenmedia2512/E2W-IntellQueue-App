...
// import {  User, ChevronDown, ChevronUp, Phone, Package } from 'lucide-react';
...
export default function ExistingClientToLeads() {
  ...
  const filteredRows = leadData; // You can add additional filtering logic based on filters & searchTerm here.
  ...
  return (
    <div className="p-6 bg-white min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 sticky top-0 left-0 right-0 z-10  p-4 ">
...
{showFilters && (
  <div className="p-4 bg-white rounded-lg shadow-sm mb-6">
    {/* Responsive grid: single column on small screens, four columns on md and larger */}
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
      ...
      <div className="flex justify-end md:justify-start">
        <button
          onClick={() => {
            toggleFilters();
            // Optionally add logic to filter data based on selected filters.
          }}
      ...
      {isHandledByChange && (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg shadow-lg w-auto max-w-md mb-16 overflow-y-auto">
            ...
            {/* Floating Radio Buttons for User Selection */}
            ...
            <div className="space-y-4 text-gray-700">
              ...
              {selectedStatus === "Not Interested" && (
                <div className="space-y-2">
                  <label className="block text-base font-medium text-gray-700">Select Not Interested Reason</label>
                  <select
              ...
              <div className="mb-4">
                <label className="block text-base font-medium text-gray-700 mb-2">Followup Date and Time</label>
                <DatePicker
              ...
              <div className="flex justify-end">
                <button
                  className={`px-4 py-2 rounded-md text-white ${isLoading ? "bg-blue-300" : "bg-blue-500 hover:bg-blue-600"} transition-all duration-200`}
                  onClick={handleSave}
      ...
      {showExpandedModal && currentLead && (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-lg relative">
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Ad Details for Order #{currentLead.OrderNumber}</h3>
