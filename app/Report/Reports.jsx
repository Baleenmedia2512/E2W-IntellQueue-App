...
<Dialog open={openCDR} onClose={handleCloseCDR}>
  ...
  <div className="flex flex-col md:flex-row sm:flex-col sm:items-start md:items-end">
    <button className="px-4 py-1 bg-green-400 text-white rounded-lg hover:bg-green-600 mb-2 mr-2" onClick={handleClickOpen}>
      Show Balance
    </button>
    {(appRights.includes('Administrator') || appRights.includes('Finance') || appRights.includes('Leadership') || appRights.includes('Admin')) && (
      <button className="px-4 py-1 bg-blue-400 text-white rounded-lg hover:bg-blue-600 mb-2 mr-2" onClick={handleConsultantReportOpen}>
        Cons. Report
      </button>
    )}
    <button className="px-4 py-1 bg-yellow-400 text-white rounded-lg hover:bg-yellow-600 mb-2 mr-2" onClick={handleOpenCDR}>
