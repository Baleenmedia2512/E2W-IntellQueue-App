  ...
  return (
    <div className='bg-gray-100 w-full max-h-full overscroll-none'>
      <div className='text-black overscroll-none'>
        ...
        <form className={`bg-white rounded-t-3xl shadow-2xl ${currentPage === 'checkout' ? 'pb-0' : 'pb-8'} ${(currentPage === 'checkout' && cartItems.length > 0) ? 'h-fit':'h-full'} overflow-y-auto max-h-[100vh] overflow-x-hidden mx-2`}>
          <br />
          {showCurrentPage()}
        </form>
