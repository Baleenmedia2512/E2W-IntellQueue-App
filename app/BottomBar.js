...
export default function BottomBarTest() {
  ...
  return (
    <div className="relative">
      {/* Main Navigation Bar */}
        {/* Main Navigation Bar */}
  <div className={`fixed bottom-0 left-0 right-0 h-20 z-50 bg-white shadow-2xl transition-transform duration-300 ease-in-out ${showBar ? 'translate-y-0' : 'translate-y-full'}`} style={{ 
