...
// Configuration
$dbName = 'Baleen Test'; // Replace with your database name if needed
...
const DB_USERNAME = "baleeed5_test";
const DB_PASSWORD = "Baleen@789#";
const DB_DATABASE = "baleeed5_test_e2w";
