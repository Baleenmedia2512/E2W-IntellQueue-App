...
$isCommissionAmountSingleUse = $orderDetails['IsCommissionAmountSingleUse'];
$consultantId = $orderDetails['ConsultantId'];
...
$response = [
    ...
    'isCommissionAmountSingleUse' => $isCommissionAmountSingleUse,
