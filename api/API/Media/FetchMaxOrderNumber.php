...
try {
    ...
    $stmtRateWise = $pdo->prepare("SELECT MAX(CAST(SUBSTRING(RateWiseOrderNumber, LOCATE('-', RateWiseOrderNumber) + 1) AS UNSIGNED)) + 1 AS NextRateWiseOrderNumber FROM order_table WHERE Card = :RateName AND RateWiseOrderNumber > 0");
